...
# Steps
  * Install the DC/OS CLI
    * Follow the steps [here](https://dcos.io/docs/1.9/usage/cli/install/) or the `Install CLI` instruction in the lower left corner of the DC/OS UI.
    ...
    * You can also add/invite friends and co-workers to your cluster. See [user management documentation](https://dcos.io/docs/1.9/administration/id-and-access-mgt/user-management/) for details
  ...
  * Explore the cluster:
      ...
      * To explore more CLI options, enter the `dcos help` command. There are also help options of the individual commands available e.g., `dcos node --help`. Alternatively, check the [CLI documentation](https://dcos.io/docs/1.9/usage/cli/).
...
A description of all components can be found in the [documentation](https://dcos.io/docs/1.9/overview/components/).
...
## DC/OS Terminology
Again we will focus on the most important terminology here. More details can be found in the [documentation](https://dcos.io/docs/1.9/overview/architecture/).
